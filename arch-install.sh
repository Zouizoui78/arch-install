...
# useful stuff
packages="${packages} git pyenv zip unrar unzip i7z ncdu htop nvtop pacman-contrib firefox rsync wget vlc qbittorrent cups pinta libdbusmenu-glib reflector"
