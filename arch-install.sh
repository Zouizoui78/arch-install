...
# useful stuff
packages="${packages} git pyenv zip unrar unzip p7zip ncdu htop nvtop pacman-contrib firefox rsync wget vlc qbittorrent cups pinta libdbusmenu-glib reflector"
